...
//            String dirPath = "D:\\Admaster\\J";
            ...
            while (iterator.hasNext()) {
                ...
                if (!item.isFormField()) {
                    ...
                    if(otherFieldName.equals("role")) role=otherFieldValue;
                    if(otherFieldName.equals("subject")) subject=otherFieldValue;
                    if(otherFieldName.equals("content")) content=otherFieldValue;
                }
            }
